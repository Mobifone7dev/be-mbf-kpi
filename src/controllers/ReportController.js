    ...
    if (monthString && startOfMonth) {
      ...
      sql = `
            SELECT
                ...
                NVL(DLA_T13_TRONG_TINH,0) + NVL(DLA_D01_TRONG_TINH,0) +  NVL(DLA_D02_TRONG_TINH,0) +
                 NVL(DLA_D03_TRONG_TINH,0) +  NVL(DLA_D04_TRONG_TINH,0) +  NVL(DLA_D05_TRONG_TINH,0)+
                  NVL(DLA_D06_TRONG_TINH,0) AS tong_trong_tinh,

                NVL(DLA_T01_NGOAI_TINH,0) + NVL(DLA_T02_NGOAI_TINH,0) + NVL(DLA_T03_NGOAI_TINH,0) +
                NVL(DLA_T04_NGOAI_TINH,0) + NVL(DLA_T05_NGOAI_TINH,0) + NVL(DLA_T06_NGOAI_TINH,0) +
                NVL(DLA_T07_NGOAI_TINH,0) + NVL(DLA_T08_NGOAI_TINH,0) + NVL(DLA_T09_NGOAI_TINH,0) +
                NVL(DLA_T10_NGOAI_TINH,0) + NVL(DLA_T11_NGOAI_TINH,0) + NVL(DLA_T12_NGOAI_TINH,0) +
                NVL(DLA_T13_NGOAI_TINH,0) + NVL(DLA_D01_NGOAI_TINH,0) + NVL(DLA_D02_NGOAI_TINH,0) + NVL(DLA_D03_NGOAI_TINH,0) +
