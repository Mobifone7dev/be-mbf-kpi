...
router.use("/dashboard-plan-kpi-dla", dashboardController.getDashBoardPlanKpiDLAEmployee);
router.use("/dashboard-plan-kpi-dla-nhan-vien", dashboardController.getDashBoardPlanKpiDLA);
